...
- Pin the adapter compatibility header and reviewed rich-model snapshot to
  Command Code CLI 1.15.0 and the integration baseline to OMP 17.2.11.
- Replace normalized provider-prefixed pricing keys with exact model-to-docs ID
  mappings and a committed 55-row official pricing/limits snapshot.
...
- Individual Go availability metadata for all 52 registered models and clearer
